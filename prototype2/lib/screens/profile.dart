...
class _ProfileState extends State<Profile> {
  ...
  void initState() {
    _languageList
        .addAll(['English', 'German', 'French', 'Chinese', 'Thai', 'Spanish']);
            ...
            new Container(
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  new LinearProgressIndicator(value: 0.6),
                ],
              ),
            ),
            new Row(
              ...
              child: new Column(
                children: <Widget>[
                  new RaisedButton(
                    ...
                    onPressed: () => openPrevious(context),
                    child: new Row(
                      children: <Widget>[
                        new Icon(Icons.business_center),
                        new Text(' See your finished courses'),
                      ],
                    ),
                  ),
                ],
  ...
  void openPrevious(BuildContext context) {
    Navigator.pushNamed(context, Routes.Previous);
  }
}
